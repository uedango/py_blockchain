...
def create_transaction():
  ...
  recipisent_blockchain_address = request_json['recipisent_blockchain_address']
  ...
  json_data = {
    ...
    'recipisent_blockchain_address': recipisent_blockchain_address,
